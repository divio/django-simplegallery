...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('simplegallery_gallery_translation', (
            ...
            ('language_code', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=5, blank=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['simplegallery.Gallery'])),
        ...
        db.create_unique('simplegallery_gallery_translation', ['language_code', 'master_id'])
        ...
        db.create_table('simplegallery_image_translation', (
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('language_code', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=5, blank=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['simplegallery.Image'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('simplegallery', ['ImageTranslation'])

        # Adding unique constraint on 'ImageTranslation', fields ['language_code', 'master']
        db.create_unique('simplegallery_image_translation', ['language_code', 'master_id'])
        ...
        db.create_table('simplegallery_image', (
            ...
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gallery', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['simplegallery.Gallery'])),
        ))
        ...
        db.create_table('cmsplugin_gallerypublication', (
            ...
            ('interval', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('gallery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['simplegallery.Gallery'])),
        ))
        ...
        db.create_table('simplegallery_carouselimage', (
            ('description_2', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('carousel_feature', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['simplegallery.CarouselFeature'])),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'])),
            ('page_link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, blank=True)),
            ('ordering', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title_2', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
        ))
        ...
        db.create_table('cmsplugin_carouselfeature', (
            ('aspect_ratio', self.gf('django.db.models.fields.FloatField')(default=1)),
            ('interval', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=3)),
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('simplegallery_gallery_translation', ['language_code', 'master_id'])
        ...
        # Removing unique constraint on 'ImageTranslation', fields ['language_code', 'master']
        db.delete_unique('simplegallery_image_translation', ['language_code', 'master_id'])
    ...
    models = {
        ...
        'simplegallery.carouselfeature': {
            'Meta': {'object_name': 'CarouselFeature', 'db_table': "'cmsplugin_carouselfeature'"},
        ...
        'simplegallery.gallerypublication': {
            'Meta': {'object_name': 'GalleryPublication', 'db_table': "'cmsplugin_gallerypublication'"},
            'aspect_ratio': ('django.db.models.fields.FloatField', [], {'default': '1'}),
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'simplegallery.gallerytranslation': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '5', 'blank': 'True'}),
