...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CarouselFeature.aspect_ratio'
        db.add_column('cmsplugin_carouselfeature', 'aspect_ratio', orm['simplegallery.carouselfeature:aspect_ratio'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CarouselFeature.aspect_ratio'
        db.delete_column('cmsplugin_carouselfeature', 'aspect_ratio')
