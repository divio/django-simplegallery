...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GalleryPublication.raw_aspect_ratio'
        db.add_column('cmsplugin_gallerypublication', 'raw_aspect_ratio', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'GalleryPublication.raw_aspect_ratio'
        db.delete_column('cmsplugin_gallerypublication', 'raw_aspect_ratio')
