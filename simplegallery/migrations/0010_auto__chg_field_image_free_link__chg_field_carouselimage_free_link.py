...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.free_link'
        db.alter_column('simplegallery_image', 'free_link', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

        # Changing field 'CarouselImage.free_link'
        db.alter_column('simplegallery_carouselimage', 'free_link', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))


    def backwards(self, orm):
        
        # Changing field 'Image.free_link'
        db.alter_column('simplegallery_image', 'free_link', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'CarouselImage.free_link'
        db.alter_column('simplegallery_carouselimage', 'free_link', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        'simplegallery.carouselimage': {
            'Meta': {'ordering': "('ordering',)", 'object_name': 'CarouselImage'},
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'free_link': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'simplegallery.gallerytranslation': {
            'Meta': {'ordering': "('language_code',)", 'unique_together': "(('language_code', 'master'),)", 'object_name': 'GalleryTranslation', 'db_table': "'simplegallery_gallery_translation'"},
