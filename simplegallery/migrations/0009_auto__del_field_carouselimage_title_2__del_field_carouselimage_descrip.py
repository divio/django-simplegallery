...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CarouselImage.title_2'
        db.delete_column('simplegallery_carouselimage', 'title_2')

        # Deleting field 'CarouselImage.description_2'
        db.delete_column('simplegallery_carouselimage', 'description_2')


    def backwards(self, orm):
        
        # Adding field 'CarouselImage.title_2'
        db.add_column('simplegallery_carouselimage', 'title_2', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True), keep_default=False)

        # Adding field 'CarouselImage.description_2'
        db.add_column('simplegallery_carouselimage', 'description_2', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
