...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Gallery.folder'
        db.add_column('simplegallery_gallery', 'folder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Folder'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Gallery.folder'
        db.delete_column('simplegallery_gallery', 'folder_id')
