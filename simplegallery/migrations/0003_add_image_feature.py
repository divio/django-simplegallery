...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_imagefeaturepublication', (
            ('cmsplugin_ptr', orm['simplegallery.ImageFeaturePublication:cmsplugin_ptr']),
            ('gallery', orm['simplegallery.ImageFeaturePublication:gallery_id']),
        ))
    ...
    models = {
        ...
        'simplegallery.imagefeaturepublication': {
            'Meta': {'db_table': "'cmsplugin_imagefeaturepublication'"},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'gallery_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['simplegallery.Gallery']"})
        },
    }
