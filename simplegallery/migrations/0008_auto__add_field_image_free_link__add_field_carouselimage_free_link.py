...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.free_link'
        db.add_column('simplegallery_image', 'free_link', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'CarouselImage.free_link'
        db.add_column('simplegallery_carouselimage', 'free_link', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.free_link'
        db.delete_column('simplegallery_image', 'free_link')

        # Deleting field 'CarouselImage.free_link'
        db.delete_column('simplegallery_carouselimage', 'free_link')
