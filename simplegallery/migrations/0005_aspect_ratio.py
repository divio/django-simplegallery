...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GalleryPublication.aspect_ratio'
        db.add_column('cmsplugin_gallerypublication', 'aspect_ratio', orm['simplegallery.gallerypublication:aspect_ratio'])
        
        # Adding field 'CarouselImage.aspect_ratio'
        db.add_column('simplegallery_carouselimage', 'aspect_ratio', orm['simplegallery.carouselimage:aspect_ratio'])
        
        # Changing field 'GalleryTranslation.master'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['simplegallery.Gallery']))
        db.alter_column('simplegallery_gallery_translation', 'master_id', orm['simplegallery.gallerytranslation:master'])
        
        # Changing field 'Image.image'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['image_filer.Image']))
        db.alter_column('simplegallery_image', 'image_id', orm['simplegallery.image:image'])
        
        # Changing field 'CarouselImage.image'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['image_filer.Image']))
        db.alter_column('simplegallery_carouselimage', 'image_id', orm['simplegallery.carouselimage:image'])
        
        # Changing field 'ImageTranslation.master'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['simplegallery.Image']))
        db.alter_column('simplegallery_image_translation', 'master_id', orm['simplegallery.imagetranslation:master'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'GalleryPublication.aspect_ratio'
        db.delete_column('cmsplugin_gallerypublication', 'aspect_ratio')
        
        # Deleting field 'CarouselImage.aspect_ratio'
        db.delete_column('simplegallery_carouselimage', 'aspect_ratio')
        
        # Changing field 'GalleryTranslation.master'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['simplegallery.Gallery'], db_index=True))
        db.alter_column('simplegallery_gallery_translation', 'master_id', orm['simplegallery.gallerytranslation:master'])
        
        # Changing field 'Image.image'
        # (to signature: ImageFilerModelImageField())
        db.alter_column('simplegallery_image', 'image_id', orm['simplegallery.image:image'])
        ...
        # Changing field 'ImageTranslation.master'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['simplegallery.Image'], db_index=True))
        db.alter_column('simplegallery_image_translation', 'master_id', orm['simplegallery.imagetranslation:master'])
